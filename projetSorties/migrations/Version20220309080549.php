 ...
 */
final class Version20220309080549 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE csv_file (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, csv_filename VARCHAR(255) NOT NULL)');
